...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--config_path", type=str, default="gan_compare/configs/dcgan_config.yaml", help="Path to a yaml model config file"
    )
    parser.add_argument(
...
if __name__ == "__main__":
    ...
    print("Loading dataset...") # When we have more datasets implemented, we can specify which one(s) to load in config.
    ...
    dataloader = DataLoader(inbreast_dataset, batch_size=config.batch_size,
