...
class GANModel:
    ...
    def _create_network(self):
        ...
        if (
        ...
        ):  # Note that this is not self.config.model_name! This here is passed as args.
            ...
            from gan_compare.training.networks.dcgan.generator import Generator
            ...
            raise ValueError(
                f"Unknown gan_type. Please revise the name of the GAN model: {self.model_name}"
            )
    ...
    def _compute_loss(
        self, output, label, epoch: int, are_outputs_logits: bool = False
    ):
    ...
    def handle_G_updates(
        self, iteration: int, fake_images, fake_conditions, epoch: int
    ):
