...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Define the associated risk of malignancy (1-6) accroding to the Breast Imaging-Reporting and Data System (BIRADS)"
    )
...
if __name__ == "__main__":
    ...
    assert Path(
        args.model_checkpoint_dir).is_dir(), f'The path to the model dir you provided does not point to a valid dir:{args.model_checkpoint_dir} '
    ...
    assert args.model_checkpoint_path is not None and Path(args.model_checkpoint_path).is_file(), (
