...
def parse_args()-> argparse.Namespace:
    ...
    parser.add_argument(
        "--model_checkpoint_dir", type=str, required=True, help="Path to model checkpoint directory"
    )    
    parser.add_argument(
        "--model_checkpoint_path", type=str, default=None, help="Path to model checkpoint .pt file"
    )
    parser.add_argument(
