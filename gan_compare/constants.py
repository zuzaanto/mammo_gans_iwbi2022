...
def get_classifier(config, num_classes:int = None) -> nn.Module:
    ...
    if config.model_name == "cnn":
        ...
        if config.image_size == 64:
            return Net64(num_labels=num_classes, return_probabilities=return_probabilities)
        elif config.image_size == 128:
            return Net128(num_labels=num_classes, return_probabilities=return_probabilities)
